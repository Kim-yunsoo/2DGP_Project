...
class Punch:
    ...
    def enter(boy, e):
        ...
        if boy.playernum==1:
            ...
            game_world.add_object(punchCollision,2)
...
class Damage:
    ...
    def draw(boy):
        if boy.face_dir == 1:
            ...
            boy.image_DAMAGE.clip_draw(0, 0, 70, 114, boy.x, boy.y + 10, 220, 280)

        elif boy.face_dir == -1:
            boy.image_DAMAGE.clip_composite_draw(0, 0, 70, 114, 0, 'h', boy.x, boy.y + 10, 220, 280)
...
class Dead:
    ...
    @staticmethod
    def draw(boy):
        pix_posx = [11, 106, 222, 333]
        if boy.face_dir == 1:
            # boy.image_KICK.clip_draw(0, 0, 70, 114, boy.x, boy.y + 10, 220, 280)
            boy.image_DEAD.clip_draw(pix_posx[int(boy.frame)],0,108,122,boy.x, boy.y,275,305)
        elif boy.face_dir == -1:
            boy.image_DEAD.clip_composite_draw(pix_posx[int(boy.frame)], 0, 108, 122, 0, 'h', boy.x, boy.y + 10, 275, 305)
...
class Moon:
    ...
    def __init__(self,playernum,round):
        ...
        if not Moon.attack_sound:
            Moon.attack_sound = load_wav('resource/sound/attack.wav')
        ...
        self.image_DAMAGE=load_image('resource/moon/moonDamage.png')
        self.image_DEAD=load_image('resource/moon/moonDead.png')
    ...
    def draw(self):
        ...
        if self.playernum==1:
            ...
            self.image_moonUI.clip_draw(0, 0, 173, 75,  900, 640,        160, 70)
            for i in range(self.hp // 5):
